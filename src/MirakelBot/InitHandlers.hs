...
miscHandlers :: [Irc ()]
miscHandlers = [MirakelBot.Handlers.Id.init,MirakelBot.Handlers.ServerComm.init,MirakelBot.Handlers.Talk.init,MirakelBot.Handlers.Mirakel.init,MirakelBot.Handlers.Users.init,MirakelBot.Handlers.Fun.init]
